...
Length=2e-10 #2e-10                                                                # Fiber length [km]
...
# NOTE: beta2<0 is anomalous dispersion with blue light pulling ahead, causing a positive leading chirp                                                           # Power attenuation coeff in decibel per m. Usual value @ 1550 nm is 0.2 dB/km 

# Some useful parameters
nonlinear_length=1/(gammaconstant*peak_power)
dispersion_length=(duration**2)/(np.abs(beta2))                                                                       # Characteristic distance scale